...
/**
 * Get moderation case details by report ID
 */
export const getModerationCase = <ThrowOnError extends boolean = false>(options: Options<GetModerationCaseData, ThrowOnError>): RequestResult<GetModerationCaseResponses, unknown, ThrowOnError> => (options.client ?? client).get<GetModerationCaseResponses, unknown, ThrowOnError>({ url: '/api/v1/moderation/case/{reportId}', ...options });

/**
 * Claim a moderation case by report ID
 */
export const claimModerationCase = <ThrowOnError extends boolean = false>(options: Options<ClaimModerationCaseData, ThrowOnError>): RequestResult<ClaimModerationCaseResponses, unknown, ThrowOnError> => (options.client ?? client).post<ClaimModerationCaseResponses, unknown, ThrowOnError>({ url: '/api/v1/moderation/case/{reportId}/claim', ...options });
