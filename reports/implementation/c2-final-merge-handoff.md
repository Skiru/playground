...
- **PR Head SHA (Expected)**: `c4083b4cac4e2ec4d9b186d699139cd9519a08cc`
- **C2 Final Implementation SHA**: `c4083b4cac4e2ec4d9b186d699139cd9519a08cc`
- **C2 Final Implementation Tree**: `9a497040d002fffbeefa871004d1bb67853f5ddf`
...
```
Expected output:
`c4083b4cac4e2ec4d9b186d699139cd9519a08cc  refs/heads/feat/family-places-platform-v1`
...
gh pr merge 1 \
  --merge \
  --match-head-commit c4083b4cac4e2ec4d9b186d699139cd9519a08cc
```

## 4. Same-Artifact Production Deployment Principles

* **No Rebuilds**: Do not rebuild "certified" PR artifacts in this merge runbook.
* **PR Artifacts Certify the Candidate**: The images built during PR #1 (`family-places-api:sha-c4083b4cac4e2ec4d9b186d699139cd9519a08cc` and `family-places-web:sha-c4083b4cac4e2ec4d9b186d699139cd9519a08cc`) are the ones that have been verified.
