...
import { loadMapPlaces, loadPlaces } from "../lib/api.server";
...
export async function loader({ request }: Route.LoaderArgs) {
  ...
  const places = await loadPlaces(query);
  ...
  return (
    <main className="shell">
      ...
      <form className="filter-bar" method="get">
        ...
        <label>Miasto <input name="city" defaultValue={loaderData.filters.city} /></label>
