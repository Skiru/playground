    ...
    private static function placeCardSchema(): array
    {
        return [
            ...
            'properties' => [
                ...
                'main_photo' => ['type' => ['object', 'null'], 'properties' => ['thumbnail_mini' => ['type' => 'string'], 'thumbnail' => ['type' => 'string'], 'card' => ['type' => 'string'], 'hero' => ['type' => 'string'], 'original' => ['type' => 'string']]],
            ],
        ];
    }
