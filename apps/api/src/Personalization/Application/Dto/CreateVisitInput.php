...
final readonly class CreateVisitInput
{
    public \DateTimeImmutable $visitedOn;
    public ?string $note;

    public function __construct(\DateTimeImmutable $visitedOn, ?string $note)
    {
    ...
    public static function fromRequest(Request $request): self
    {
        ...
        return new self($visitedOn, $note);
    }
}
