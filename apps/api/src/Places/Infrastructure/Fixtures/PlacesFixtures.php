...
final class PlacesFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        foreach ($names as $index => $name) {
            ...
            $this->connection->executeStatement(
                'INSERT INTO places (id,city_id,primary_category_id,slug,name,normalized_name,short_description,description,status,verification_status,address_line1,postal_code,country_code,location,latitude,longitude,timezone,indoor,outdoor,free_entry,verified_at,published_at,created_at,updated_at,version) VALUES (:id,:city,:category,:slug,:name,:normalized,:short,:description,:status,:verification,:address,\'00-001\',\'PL\',ST_SetSRID(ST_MakePoint(:lon,:lat),4326)::geography,:lat,:lon,\'Europe/Warsaw\',:indoor,:outdoor,:free,:verified,:published,:now,:now,1)',
